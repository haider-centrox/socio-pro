  ...
  return (
    <div className="text-socie-black mx-auto flex flex-col items-center justify-center gap-5 overflow-x-hidden text-center">
      ...
      <div className="flex flex-wrap justify-center gap-8 py-16">
        <div className="flex max-w-80 flex-col items-center justify-center rounded-2xl shadow-lg">
          <div className="flex w-full justify-center rounded-md py-5 shadow-md">
            <Image
          ...
          <div className="bg-socie-yellow flex h-full flex-col gap-4 p-4">
        ...
        <div className="flex max-w-80 flex-col items-center justify-center rounded-2xl shadow-lg">
          ...
          <div className="bg-socie-green flex h-full flex-col gap-4 p-4">
            <h5 className="text-socie-black text-center text-lg font-bold md:text-xl">
              Smarter Decisions
            </h5>
            <p className="text-socie-gray text-sm">
        ...
        <div className="flex max-w-80 flex-col items-center justify-center rounded-2xl shadow-lg">
          <div className="flex w-full justify-center rounded-md py-6 shadow-md">
            <Image
          ...
          <div className="bg-socie-peach flex h-full flex-col gap-4 p-4">
            <h5 className="text-socie-black text-center text-lg font-bold md:text-xl">
        ...
        <div className="flex max-w-80 flex-col items-center justify-center rounded-2xl shadow-lg">
          ...
          <div className="bg-socie-purple flex h-full flex-col gap-4 p-4">
            <h5 className="text-socie-black text-center text-lg font-bold md:text-xl">
              Increased Traffic
            </h5>
            <p className="text-socie-gray text-sm">
